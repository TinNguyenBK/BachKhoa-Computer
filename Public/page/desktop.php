  ...
  <body data-spy="scroll" data-target="#navbarResponsive">
    ...
    <div class="container ">
      <div class="link ">
        ...
        <a href="#" class="breadcrumb-link"><b>Màn hình</b></a> >
      </div>
      <div class="row mt-2">
        <div
        ...
        >
              ...
              <div class="catagories-menu">
                <ul id="menu-content2" class="menu-content collapse show">
                  ...
                  >
                    ...
                    >
                    <ul class="sub-menu collapse" id="psc">
          ...
          <!-- Giá sản phẩm -->
          <div class="range mt-5 d-none d-md-block">
            <h5 class="title">GIÁ SẢN PHẨM</h5>
            <input
              type="range"
              class="custom-range"
              min="0"
        ...
        >
          <div class="d-flex justify-content-center banner">
            <a href="./Detail.html"
              ><img
                src="./Public/images/PC-product/banner-PC-1.jpg"
                alt="banner2"
                title="Big Sale 2019"
            /></a>
          </div>
          <div class="shop_product_area mt-2">
                ...
                >
                  ...
                  <div class="total-products cover">
                    <p style="margin: 0px; padding: 0px;">
                      Màn hình: <span>286</span> sản phẩm
                    </p>
                  </div>
                  <!-- Sorting -->
                ...
                <div class="item owl-carousel owl-theme">
                  <div class="sale">
                    <a href="">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_6.jpg"
                          alt=""
                          title="Màn Hình Cong Samsung LC27F591FDEXXV 27inch FullHD 4ms 60Hz FreeSync VA Speaker"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Cong Samsung LC27F591FDEXXV 27inch FullHD
                            4ms 60Hz FreeSync VA Speaker
                          </h6>
                        </a>
                  ...
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_1.jpg"
                          alt=""
                          title="Màn Hình Dell U2419H 24inch FullHD 8ms 60Hz IPS VA Speaker- Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Dell U2419HHDGSH 24inch FullHD 8ms 60Hz IPS
                            VA Speaker - Hàng Chính Hãng
                          </h6>
                        </a>
                        <p class="product-price">
                  ...
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_2.jpg"
                          alt=""
                          title="Màn Hình Dell P2319H 23inch FullHD 8ms 60Hz IPS - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Dell P2319H 23inch FullHD 8ms 60Hz IPS -
                            Hàng Chính Hãng
                          </h6>
                        </a>
                        <p class="product-price">
                ...
                <div class="item">
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_3.jpg"
                          alt=""
                          title="Màn Hình Gaming LG 24MP59G-P 24inch FullHD 5ms 75Hz FreeSync IPS - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Gaming LG 24MP59G-P 24inch FullHD 5ms 75Hz
                            FreeSync IPS - Hàng Chính Hãng
                          </h6>
                        </a>
                        <p class="product-price">
                  ...
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_4.jpg"
                          alt=""
                          title="Màn Hình Dell U2518GSXD 25inch 2K 5ms 60Hz IPS  FreeSync VA Speaker - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Dell U2518GSXD 25inch 2K 5ms 60Hz IPS
                            FreeSync VA Speaker - Hàng Chính Hãng
                          </h6>
                        </a>
                        <p class="product-price">
                  ...
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_5.jpg"
                          alt=""
                          title="Màn Hình Dell P2419H 24inch FullHD 8ms 60Hz IPS - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Dell P2419H 24inch FullHD 8ms 60Hz IPS -
                            Hàng Chính Hãng
                          </h6>
                        </a>
                        <p class="product-price">
                ...
                <div class="item">
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_7.jpg"
                          alt=""
                          title="Màn Hình Samsung LU28E590DS/XV 28inch 4K 1ms 60Hz FreeSync TN - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                  ...
                  <div class="sale">
                    <a href="./Detail.html">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_8.jpg"
                          alt=""
                          title="Màn Hình Gaming Dell SE2417HGAPX 24inch FullHD 2ms 76 Hz TN - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Gaming Dell SE2417HGAPX 24inch FullHD 2ms
                            76 Hz TN - Hàng Chính Hãng
                          </h6>
                        </a>
                        <p class="product-price">
                  ...
                  <div class="sale">
                    <a href="">
                      <div class="col-12 d-flex justify-content-center">
                        <img
                          src="./Public/images/PC-product/product_9.jpg"
                          alt=""
                          title="Màn Hình Gaming LG 27MP59G-P 27inch FullHD 1ms 75Hz FreeSync IPS - Hàng Chính Hãng"
                        />
                      </div>
                    </a>
                      <div class="col-12 text-justify">
                        ...
                        <a href="./Detail.html">
                          <h6>
                            Màn Hình Gaming LG 27MP59G-P 27inch FullHD 1ms 75Hz
                            FreeSync IPS
                          </h6>
                        </a>
                        <p class="product-price">
            ...
            <nav aria-label="navigation">
              <ul class="pagination mt-30 mb-50">
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html"
                    ><i class="fa fa-angle-left"></i
                  ></a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html">1</a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html">2</a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html">3</a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html">...</a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html">21</a>
                </li>
                <li class="page-item">
                  <a class="page-link" href="../HTML/Desktop.html"
